...
import {CalendarDays, Check, Ellipsis, Link2, MapPin} from "lucide-react";
...
const Profile = () => {
    ...
    const clearProfileStore = useProfileStore((state) => state?.clearProfileStore);
    ...
    useEffect(() => {
        ...
        const fetchProfile = async () => {
            try {
                const res = await getProfile({username: username, params: {page: page}});
                            ...
                            <div className="w-full mx-auto flex flex-col items-start justify-center gap-x-8">
                                ...
                                <div className="w-full text-sm flex flex-col items-start justify-start">
                                    ...
                                    <div className="w-full flex items-center justify-start gap-4">
                                        <p className="w-full leading-normal">
                    ...
                    <div className="border-t px-6 md:px-12">
                        ...
                        >
                            {posts && posts?.results.length > 0 ? (
                                ...
                                <div className="w-full py-32 col-span-full flex items-center justify-center">
