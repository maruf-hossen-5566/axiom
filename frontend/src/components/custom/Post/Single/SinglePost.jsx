            ...
            >
                <CardHeader>
                    <div className="aspect-video w-full mb-2">
                        <img
                            loading="lazy"
                            src={post?.thumbnail?.image || "https://images.unsplash.com/photo-1533371452382-d45a9da51ad9?q=80&w=1173&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
                ...
                <CardContent>
                    ...
                    <div className="mt-4 flex items-center gap-2">
                        ...
                        <p className={"text-sm font-normal hover:underline"}>{`${post?.author?.full_name || "No Name"}`}</p>
                    </div>
                </CardContent>
            </Card>
        </Link>);
