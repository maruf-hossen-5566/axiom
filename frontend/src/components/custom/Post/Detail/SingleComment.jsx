import {addComment, deleteComment, likeComment, updateComment,} from "@/api/commentApi";
...
export const SingleComment = ({comment}) => {
    ...
    const handleUpdate = async () => {
        setLoading(true);
        try {
            const data = {...comment, content: updateCommentText, post_id: post?.id};
                ...
                <div className="w-full flex items-start justify-between gap-4">
                    ...
                    <div className="w-full flex flex-col">
                        <div className="flex items-center gap-2">
                            ...
                            {comment && post && comment?.author?.id === user?.id ? (<Badge className="rounded-full">
                                You
                            </Badge>) : comment?.author?.id === post.author?.id ? (<Badge className="rounded-full">
                                Author
                            </Badge>) : ("")}
                        </div>
